...
export class VisiteComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: 'Bienvenue dans la salle de sport yakhasport fumel "la fabrik", 1100m² d\'espaces dédiés à l\'activité sportive, Visite de la salle de sport La Fabrik Fumel, photos des salles, photos vestiaires, photos accueil' }
    );
